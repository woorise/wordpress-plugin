...
function createPersistenceInterface(options) {
  ...
  function setData(key, value) {
    data = _objectSpread(_objectSpread({}, data), {}, (0, _defineProperty2.default)({}, key, value));
...
persistencePlugin.__unstableMigrate = function (pluginOptions) {
  ...
  if (editorInsertUsage) {
    ...
    persistence.set('core/block-editor', {
      preferences: {
        insertUsage: _objectSpread(_objectSpread({}, editorInsertUsage), blockEditorInsertUsage)
      }
    });
  }
  ...
  var hadFullscreenModePreference = (0, _lodash.has)(state, ['core/edit-post', 'preferences', 'features', 'fullscreenMode']);
