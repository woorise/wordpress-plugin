...
export var attrs = memize(function (text) {
  var named = {};
...
var shortcode = extend(function (options) {
  var _this = this;
...
extend(shortcode.prototype, {
  ...
  string: function string() {
    var text = '[' + this.tag;
    forEach(this.attrs.numeric, function (value) {
      if (/\s/.test(value)) {
        text += ' "' + value + '"';
      } else {
        text += ' ' + value;
    ...
    forEach(this.attrs.named, function (value, name) {
      text += ' ' + name + '="' + value + '"';
