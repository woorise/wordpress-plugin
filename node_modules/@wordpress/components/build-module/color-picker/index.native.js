...
function ColorPicker(_ref) {
  ...
  var _ref2 = !isGradientColor && activeColor ? tinycolor(activeColor).toHsv() : {
    h: 0,
    s: 0.5,
    v: 0.5
  },
  ...
  var _useState = useState(initH),
      _useState2 = _slicedToArray(_useState, 2),
      hue = _useState2[0],
      setHue = _useState2[1];

  var _useState3 = useState(initS),
      _useState4 = _slicedToArray(_useState3, 2),
      sat = _useState4[0],
      setSaturation = _useState4[1];

  var _useState5 = useState(initV),
  ...
  var selectColorTextStyle = usePreferredColorSchemeStyle(styles.selectColorText, styles.selectColorTextDark);
