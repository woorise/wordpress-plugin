...
function _getComputedBackgroundColor(backgroundColor) {
  ...
  var computedColor = (_window = window) === null || _window === void 0 ? void 0 : _window.getComputedStyle(el).background; // Reset
...
export function getOptimalTextColor(backgroundColor) {
  var background = getComputedBackgroundColor(backgroundColor);
  var isReadableWithBlackText = tinycolor.isReadable(background, '#000000');
...
export function getOptimalTextShade(backgroundColor) {
  var result = getOptimalTextColor(backgroundColor);
