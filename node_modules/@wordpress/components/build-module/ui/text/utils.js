...
export function createHighlighterText(_ref) {
  ...
  var textContent = chunks.map(function (chunk, index) {
    ...
    if (chunk.highlight) {
      ...
      if (_typeof(highlightClassName) === 'object') {
        if (!caseSensitive) {
      ...
      var props = _objectSpread(_objectSpread({}, ui.$('TextHighlight')), {}, {
        children: text,
    ...
    return createElement('span', _objectSpread(_objectSpread({}, ui.$('Text')), {}, {
      children: text,
