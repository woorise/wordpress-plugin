...
export default function useTruncate(props) {
  ...
  var truncatedContent = truncateContent(typeof children === 'string' ?
  /** @type {string} */
  children : '', {
    ellipsis: ellipsis,
  ...
  var shouldTruncate = ellipsizeMode === TRUNCATE_TYPE.auto;
  var classes = useMemo(function () {
    var sx = {};
    sx.numberOfLines = css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\t\t\t-webkit-box-orient: vertical;\n\t\t\t-webkit-line-clamp: ", ";\n\t\t\tdisplay: -webkit-box;\n\t\t\toverflow: hidden;\n\t\t"])), numberOfLines);
