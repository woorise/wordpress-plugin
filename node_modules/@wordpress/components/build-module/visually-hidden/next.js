...
var VisuallyHidden = process.env.COMPONENT_SYSTEM_PHASE === 1 ? NextVisuallyHidden : undefined;
/**
...
export function withNextComponent(Current) {
  return withNext(Current, VisuallyHidden, 'WPComponentsVisuallyHidden', adapter);
}
