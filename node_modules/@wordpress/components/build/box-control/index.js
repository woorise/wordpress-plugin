...
function BoxControl(_ref) {
  ...
  var handleOnHoverOn = function handleOnHoverOn() {
    ...
    onChangeShowVisualizer(_objectSpread(_objectSpread({}, _utils.DEFAULT_VISUALIZER_VALUES), next));
  };
  ...
  var inputControlProps = _objectSpread(_objectSpread({}, inputProps), {}, {
  ...
  return (0, _element.createElement)(_boxControlStyles.Root, {
    ...
    "aria-label": label
  }, inputControlProps))), (0, _element.createElement)(_flex.FlexItem, null, (0, _element.createElement)(_linkedButton.default, {
