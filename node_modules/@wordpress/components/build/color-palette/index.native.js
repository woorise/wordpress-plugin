...
function ColorPalette(_ref) {
  ...
  var _useState = (0, _element.useState)(shouldShowCustomIndicatorOption && (!isGradientSegment || isCustomGradientColor)),
  ...
  var customIndicatorWrapperStyle = [_style.default.customIndicatorWrapper, customIndicatorWrapperStyles];
