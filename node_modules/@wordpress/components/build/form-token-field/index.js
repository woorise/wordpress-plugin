...
var FormTokenField = /*#__PURE__*/function (_Component) {
  ...
  function FormTokenField() {
    ...
    _this.deleteTokenBeforeInput = _this.deleteTokenBeforeInput.bind((0, _assertThisInitialized2.default)(_this));
    _this.deleteTokenAfterInput = _this.deleteTokenAfterInput.bind((0, _assertThisInitialized2.default)(_this));
    _this.addCurrentToken = _this.addCurrentToken.bind((0, _assertThisInitialized2.default)(_this));
    _this.onContainerTouched = _this.onContainerTouched.bind((0, _assertThisInitialized2.default)(_this));
    _this.renderToken = _this.renderToken.bind((0, _assertThisInitialized2.default)(_this));
    _this.onTokenClickRemove = _this.onTokenClickRemove.bind((0, _assertThisInitialized2.default)(_this));
  ...
  (0, _createClass2.default)(FormTokenField, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          label = _this$props4$label === void 0 ? (0, _i18n.__)('Add item') : _this$props4$label,
