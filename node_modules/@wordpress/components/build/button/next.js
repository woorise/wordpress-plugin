...
var _tooltipButton = require("../ui/tooltip-button");
...
var Button = process.env.COMPONENT_SYSTEM_PHASE === 1 ? _tooltipButton.TooltipButton : undefined;
...
var adapter = function adapter(_ref2) {
  var isPrimary = _ref2.isPrimary,
      ...
      text = _ref2.text,
      props = (0, _objectWithoutProperties2.default)(_ref2, ["isPrimary", "isTertiary", "isSecondary", "isLink", "isDefault", "isSmall", "isBusy", "label", "aria-label", "describedBy", "shortcut", "tooltipPosition", "text"]);
...
function withNextComponent(Component) {
  return (0, _context.withNext)(Component, Button, 'WPComponentsButton', adapter);
}
