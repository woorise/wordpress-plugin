...
var eventCatcher = (0, _element.createElement)("div", {
...
var getRegularElement = function getRegularElement(_ref2) {
  ...
  return (0, _element.cloneElement)(child, _objectSpread(_objectSpread({}, eventHandlers), {}, {
    children: childrenWithPopover
  }));
};
...
function Tooltip(_ref4) {
  ...
  var delayedSetIsOver = (0, _compose.useDebounce)(setIsOver, TOOLTIP_DELAY);
  ...
  var createToggleIsOver = function createToggleIsOver(eventName, isDelayed) {
    return function (event) {
      ...
      var _isOver = (0, _lodash.includes)(['focus', 'mouseenter'], event.type);
