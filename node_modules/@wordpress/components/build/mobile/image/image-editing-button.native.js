 ...
 */
var accessibilityHint = _reactNative.Platform.OS === 'ios' ? (0, _i18n.__)('Double tap to open Action Sheet to edit, replace, or clear the image') : (0, _i18n.__)('Double tap to open Bottom Sheet to edit, replace, or clear the image');

var ImageEditingButton = function ImageEditingButton(_ref) {
  var onSelectMediaUploadOption = _ref.onSelectMediaUploadOption,
  ...
  return (0, _element.createElement)(_mediaEdit.MediaEdit, {
    ...
    render: function render(_ref2) {
      var open = _ref2.open,
          mediaOptions = _ref2.mediaOptions;
