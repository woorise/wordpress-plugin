  ...
  (0, _createClass2.default)(BottomSheetCell, [{
    ...
    value: function render() {
      ...
      var separatorStyle = function separatorStyle() {
        ...
        var leftMarginStyle = _objectSpread(_objectSpread({}, cellSeparatorStyle), _cellStyles.default.separatorMarginLeft);
      ...
      var getValueComponent = function getValueComponent() {
        ...
        var finalStyle = _objectSpread(_objectSpread(_objectSpread({}, cellValueStyle), valueStyle), styleRTL); // To be able to show the `middle` ellipsizeMode on editable cells
        ...
        return _this3.state.isEditingValue || shouldShowPlaceholder ? (0, _element.createElement)(_reactNative.TextInput, (0, _extends2.default)({
          ...
          style: _objectSpread(_objectSpread({}, cellValueStyle), valueStyle),
          numberOfLines: 1,
