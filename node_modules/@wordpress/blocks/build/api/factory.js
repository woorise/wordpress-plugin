...
function createBlock(name) {
  ...
  var sanitizedAttributes = (0, _utils.__experimentalSanitizeBlockAttributes)(name, attributes);
...
function createBlocksFromInnerBlocksTemplate() {
  ...
  return innerBlocksOrTemplate.map(function (innerBlock) {
    ...
    var _innerBlockTemplate = (0, _slicedToArray2.default)(innerBlockTemplate, 3),
...
function __experimentalCloneSanitizedBlock(block) {
  ...
  var sanitizedAttributes = (0, _utils.__experimentalSanitizeBlockAttributes)(block.name, _objectSpread(_objectSpread({}, block.attributes), mergeAttributes));
