...
function getBlockProps() {
  ...
  return (0, _hooks.applyFilters)('blocks.getSaveContent.extraProps', _objectSpread({}, props), blockType, attributes);
}
/**
...
function getSaveElement(blockTypeOrName, attributes) {
  ...
  var hasLightBlockWrapper = blockType.apiVersion > 1 || (0, _registration.hasBlockSupport)(blockType, 'lightBlockWrapper', false);

  if ((0, _lodash.isObject)(element) && (0, _hooks.hasFilter)('blocks.getSaveContent.extraProps') && !hasLightBlockWrapper) {
    /**
