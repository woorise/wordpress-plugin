...
function getBlockContentSchemaFromTransforms(transforms, context) {
  var phrasingContentSchema = (0, _dom.getPhrasingContentSchema)(context);
  var schemaArgs = {
  ...
  var schemas = transforms.map(function (_ref) {
    ...
    schema = (0, _lodash.isFunction)(schema) ? schema(schemaArgs) : schema; // If the block does not has anchor support and the transform does not
