...
import { every, castArray, findIndex, isObjectLike, filter, first, flatMap, has, uniq, isFunction, isEmpty, map } from 'lodash';
/**
...
export function createBlocksFromInnerBlocksTemplate() {
  ...
  return innerBlocksOrTemplate.map(function (innerBlock) {
    ...
    var _innerBlockTemplate = _slicedToArray(innerBlockTemplate, 3),
...
export function __experimentalCloneSanitizedBlock(block) {
  ...
  var sanitizedAttributes = __experimentalSanitizeBlockAttributes(block.name, _objectSpread(_objectSpread({}, block.attributes), mergeAttributes));
...
export function cloneBlock(block) {
  ...
  return _objectSpread(_objectSpread({}, block), {}, {
    clientId: clientId,
    attributes: _objectSpread(_objectSpread({}, block.attributes), mergeAttributes),
    innerBlocks: newInnerBlocks || block.innerBlocks.map(function (innerBlock) {
...
export function switchToBlockType(blocks, name) {
  ...
  return transformationResults.map(function (result, index) {
    var transformedBlock = _objectSpread(_objectSpread({}, result), {}, {
