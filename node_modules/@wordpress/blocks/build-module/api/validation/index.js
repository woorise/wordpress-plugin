...
export var DecodeEntityParser = /*#__PURE__*/function () {
...
export function isEqualTagAttributePairs(actual, expected) {
  ...
  for (var _i = 0; _i < actual.length; _i++) {
    var _actual$_i = _slicedToArray(actual[_i], 2),
        name = _actual$_i[0],
...
export var isEqualTokensOfType = {
  StartTag: function StartTag(actual, expected) {
    ...
    return isEqualTagAttributePairs.apply(void 0, _toConsumableArray([actual, expected].map(getMeaningfulAttributePairs)).concat([logger]));
  },
...
export function getBlockContentValidationResult(blockTypeOrName, attributes, originalBlockContent) {
