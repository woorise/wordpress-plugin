...
export function getBlockProps() {
  ...
  return applyFilters('blocks.getSaveContent.extraProps', _objectSpread({}, props), blockType, attributes);
}
/**
...
export function getSaveElement(blockTypeOrName, attributes) {
  ...
  var hasLightBlockWrapper = blockType.apiVersion > 1 || hasBlockSupport(blockType, 'lightBlockWrapper', false);
