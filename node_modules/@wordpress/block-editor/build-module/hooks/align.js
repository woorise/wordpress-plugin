...
export var withToolbarControls = createHigherOrderComponent(function (BlockEdit) {
  return function (props) {
    ...
    var blockAllowedAlignments = getValidAlignments(getBlockSupport(blockName, 'align'), hasBlockSupport(blockName, 'alignWide', true));
    var validAlignments = useAvailableAlignments(blockAllowedAlignments);
...
export var withDataAlign = createHigherOrderComponent(function (BlockListBlock) {
  return function (props) {
    ...
    var blockAllowedAlignments = getValidAlignments(getBlockSupport(name, 'align'), hasBlockSupport(name, 'alignWide', true));
    var validAlignments = useAvailableAlignments(blockAllowedAlignments); // If an alignment is not assigned, there's no need to go through the
