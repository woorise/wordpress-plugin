...
var _marked = /*#__PURE__*/_regeneratorRuntime.mark(ensureDefaultBlock),
    _marked2 = /*#__PURE__*/_regeneratorRuntime.mark(resetBlocks),
    _marked3 = /*#__PURE__*/_regeneratorRuntime.mark(validateBlocksToTemplate),
    _marked4 = /*#__PURE__*/_regeneratorRuntime.mark(selectPreviousBlock),
    _marked5 = /*#__PURE__*/_regeneratorRuntime.mark(selectNextBlock),
    _marked6 = /*#__PURE__*/_regeneratorRuntime.mark(multiSelect),
    _marked7 = /*#__PURE__*/_regeneratorRuntime.mark(replaceBlocks),
    _marked8 = /*#__PURE__*/_regeneratorRuntime.mark(moveBlocksToPosition),
    _marked9 = /*#__PURE__*/_regeneratorRuntime.mark(moveBlockToPosition),
    _marked10 = /*#__PURE__*/_regeneratorRuntime.mark(insertBlocks),
    _marked11 = /*#__PURE__*/_regeneratorRuntime.mark(synchronizeTemplate),
    _marked12 = /*#__PURE__*/_regeneratorRuntime.mark(mergeBlocks),
    _marked13 = /*#__PURE__*/_regeneratorRuntime.mark(removeBlocks),
    _marked14 = /*#__PURE__*/_regeneratorRuntime.mark(__unstableMarkAutomaticChange),
    _marked15 = /*#__PURE__*/_regeneratorRuntime.mark(setNavigationMode),
    _marked16 = /*#__PURE__*/_regeneratorRuntime.mark(setBlockMovingClientId),
    _marked17 = /*#__PURE__*/_regeneratorRuntime.mark(duplicateBlocks),
    _marked18 = /*#__PURE__*/_regeneratorRuntime.mark(insertBeforeBlock),
    _marked19 = /*#__PURE__*/_regeneratorRuntime.mark(insertAfterBlock),
    _marked20 = /*#__PURE__*/_regeneratorRuntime.mark(flashBlock);
  ...
  return _regeneratorRuntime.wrap(function ensureDefaultBlock$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return controls.select(blockEditorStoreName, 'getBlockCount');
...
export function resetBlocks(blocks) {
  return _regeneratorRuntime.wrap(function resetBlocks$(_context2) {
    while (1) {
...
export function validateBlocksToTemplate(blocks) {
  ...
  return _regeneratorRuntime.wrap(function validateBlocksToTemplate$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return controls.select(blockEditorStoreName, 'getTemplate');

        case 2:
          template = _context3.sent;
          _context3.next = 5;
          return controls.select(blockEditorStoreName, 'getTemplateLock');

        case 5:
          templateLock = _context3.sent;
          // Unlocked templates are considered always valid because they act
          // as default values only.
          isBlocksValidToTemplate = !template || templateLock !== 'all' || doBlocksMatchTemplate(blocks, template); // Update if validity has changed.

          _context3.next = 9;
          return controls.select(blockEditorStoreName, 'isValidTemplate');
...
export function selectPreviousBlock(clientId) {
  ...
  return _regeneratorRuntime.wrap(function selectPreviousBlock$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return controls.select(blockEditorStoreName, 'getPreviousBlockClientId', clientId);
...
export function selectNextBlock(clientId) {
  ...
  return _regeneratorRuntime.wrap(function selectNextBlock$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.next = 2;
          return controls.select(blockEditorStoreName, 'getNextBlockClientId', clientId);
...
export function multiSelect(start, end) {
  var blockCount;
  return _regeneratorRuntime.wrap(function multiSelect$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 2:
          _context6.next = 4;
          return controls.select(blockEditorStoreName, 'getSelectedBlockCount');
...
export function replaceBlocks(clientIds, blocks, indexToSelect) {
  var initialPosition,
      ...
      canInsertBlock,
      _args7 = arguments;
  return _regeneratorRuntime.wrap(function replaceBlocks$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          ...
          _context7.next = 7;
          return controls.select(blockEditorStoreName, 'getSettings');

        case 7:
          _context7.t2 = _context7.sent;
          blocks = (0, _context7.t0)(_context7.t1, _context7.t2);
          _context7.next = 11;
          return controls.select(blockEditorStoreName, 'getBlockRootClientId', first(clientIds));
        ...
        case 13:
          ...
          block = blocks[index];
          _context7.next = 17;
          return controls.select(blockEditorStoreName, 'canInsertBlockType', block.name, rootClientId);
...
export function moveBlocksToPosition(clientIds) {
  var fromRootClientId,
      ...
      canInsertBlocks,
      _args8 = arguments;
  return _regeneratorRuntime.wrap(function moveBlocksToPosition$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          ...
          _context8.next = 5;
          return controls.select(blockEditorStoreName, 'getTemplateLock', fromRootClientId);
        ...
        case 15:
          _context8.next = 17;
          return controls.select(blockEditorStoreName, 'canInsertBlocks', clientIds, toRootClientId);
...
export function moveBlockToPosition(clientId) {
  var fromRootClientId,
      ...
      index,
      _args9 = arguments;
  return _regeneratorRuntime.wrap(function moveBlockToPosition$(_context9) {
    while (1) {
...
export function insertBlocks(blocks, index, rootClientId) {
  ...
  return _regeneratorRuntime.wrap(function insertBlocks$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
          ...
          _context10.t1 = castArray(blocks);
          _context10.next = 8;
          return controls.select(blockEditorStoreName, 'getSettings');
...
export function synchronizeTemplate() {
  ...
  return _regeneratorRuntime.wrap(function synchronizeTemplate$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 2:
          _context11.next = 4;
          return controls.select(blockEditorStoreName, 'getBlocks');
        ...
        case 7:
          ...
          updatedBlockList = synchronizeBlocksWithTemplate(blocks, template);
          _context11.next = 11;
...
export function mergeBlocks(firstBlockClientId, secondBlockClientId) {
  ...
  return _regeneratorRuntime.wrap(function mergeBlocks$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 3:
          ...
          _context12.next = 6;
          return controls.select(blockEditorStoreName, 'getBlock', clientIdA);

        case 6:
          blockA = _context12.sent;
          blockAType = getBlockType(blockA.name); // Only focus the previous block if it's not mergeable
        ...
        case 12:
          _context12.next = 14;
          return controls.select(blockEditorStoreName, 'getBlock', clientIdB);

        case 14:
          blockB = _context12.sent;
          blockBType = getBlockType(blockB.name);
          _context12.next = 18;
          return controls.select(blockEditorStoreName, 'getSelectionStart');
        ...
        case 18:
          ...
          cloneA = cloneBlock(blockA);
          cloneB = cloneBlock(blockB);
          ...
          blocksWithTheSameType = blockA.name === blockB.name ? [cloneB] : switchToBlockType(cloneB, blockA.name); // If the block types can not match, do nothing
        ...
        case 33:
          ...
          newAttributeKey = findKey(updatedAttributes, function (v) {
          ...
          newValue = remove(convertedValue, newOffset, newOffset + 1);
          newHtml = toHTMLString({
            value: newValue,
            multilineTag: _multilineTag,
            preserveWhiteSpace: _preserveWhiteSpace
          });
        ...
        case 45:
          ...
          })].concat(_toConsumableArray(blocksWithTheSameType.slice(1)))), "t0", 46);
...
export function removeBlocks(clientIds) {
  var selectPrevious,
      ...
      defaultBlockId,
      _args13 = arguments;
  return _regeneratorRuntime.wrap(function removeBlocks$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 3:
          clientIds = castArray(clientIds);
          _context13.next = 6;
          return controls.select(blockEditorStoreName, 'getBlockRootClientId', clientIds[0]);

        case 6:
          rootClientId = _context13.sent;
          _context13.next = 9;
          return controls.select(blockEditorStoreName, 'getTemplateLock', rootClientId);
        ...
        case 18:
          _context13.next = 20;
          return controls.select(blockEditorStoreName, 'getPreviousBlockClientId', clientIds[0]);
...
export function __unstableMarkAutomaticChange() {
  return _regeneratorRuntime.wrap(function __unstableMarkAutomaticChange$(_context14) {
    while (1) {
...
export function setNavigationMode() {
  var isNavigationMode,
      _args15 = arguments;
  return _regeneratorRuntime.wrap(function setNavigationMode$(_context15) {
    while (1) {
...
export function setBlockMovingClientId() {
  var hasBlockMovingClientId,
      _args16 = arguments;
  return _regeneratorRuntime.wrap(function setBlockMovingClientId$(_context16) {
    while (1) {
...
export function duplicateBlocks(clientIds) {
  var updateSelection,
      ...
      clonedBlocks,
      _args17 = arguments;
  return _regeneratorRuntime.wrap(function duplicateBlocks$(_context17) {
    while (1) {
      switch (_context17.prev = _context17.next) {
        ...
        case 3:
          _context17.next = 5;
          return controls.select(blockEditorStoreName, 'getBlocksByClientId', clientIds);
        ...
        case 14:
          _context17.next = 16;
          return controls.select(blockEditorStoreName, 'getBlockIndex', last(castArray(clientIds)), rootClientId);
...
export function insertBeforeBlock(clientId) {
  ...
  return _regeneratorRuntime.wrap(function insertBeforeBlock$(_context18) {
    while (1) {
      switch (_context18.prev = _context18.next) {
        ...
        case 2:
          _context18.next = 4;
          return controls.select(blockEditorStoreName, 'getBlockRootClientId', clientId);
        ...
        case 10:
          _context18.next = 12;
          return controls.select(blockEditorStoreName, 'getBlockIndex', clientId, rootClientId);
...
export function insertAfterBlock(clientId) {
  var rootClientId, isLocked, firstSelectedIndex;
  return _regeneratorRuntime.wrap(function insertAfterBlock$(_context19) {
    while (1) {
...
export function flashBlock(clientId) {
  return _regeneratorRuntime.wrap(function flashBlock$(_context20) {
    while (1) {
