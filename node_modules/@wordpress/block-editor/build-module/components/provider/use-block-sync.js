...
export default function useBlockSync(_ref) {
  ...
  var _registry$dispatch = registry.dispatch(blockEditorStore),
  ...
  var _registry$select = registry.select(blockEditorStore),
  ...
  useEffect(function () {
    var _registry$select2 = registry.select(blockEditorStore),
