...
function InsertionPointPopover(_ref2) {
  ...
  var getAnchorRect = useCallback(function () {
    var previousRect = previousElement.getBoundingClientRect();
    var nextRect = nextElement ? nextElement.getBoundingClientRect() : null;
  ...
  var className = classnames('block-editor-block-list__insertion-point', 'is-' + orientation);
  ...
  return createElement(Popover, {
    ...
    className: className,
    style: style
  }, showInsertionPointIndicator && createElement("div", {
    className: "block-editor-block-list__insertion-point-indicator"
  }), showInsertionPointInserter && createElement(InsertionPointInserter, {
    rootClientId: rootClientId,
