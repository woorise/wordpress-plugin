...
export var MediaUploadProgress = /*#__PURE__*/function (_Component) {
  _inherits(MediaUploadProgress, _Component);
  ...
  _createClass(MediaUploadProgress, [{
    ...
    value: function render() {
      ...
      var progressBarStyle = [styles.progressBar, showSpinner || styles.progressBarHidden, this.props.progressBarStyle];
