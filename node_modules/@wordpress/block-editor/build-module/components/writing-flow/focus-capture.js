...
var FocusCapture = forwardRef(function (_ref, ref) {
  ...
  var isNavigationMode = useSelect(function (select) {
    return select(blockEditorStore).isNavigationMode();
  });
  ...
  function onFocus() {
    ...
    if (!selectedClientId) {
      ...
      var tabbables = focus.tabbable.find(containerRef.current);
