...
export function useTypewriter() {
  var hasSelectedBlock = useSelect(function (select) {
  ...
  return useRefEffect(function (node) {
    ...
    function maintainCaretPosition(_ref) {
      ...
      var currentCaretRect = computeCaretRect(defaultView);
      ...
      var scrollContainer = getScrollContainer(node); // The page must be scrollable.
