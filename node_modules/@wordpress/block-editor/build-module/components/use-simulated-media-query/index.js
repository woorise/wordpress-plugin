...
function getStyleSheetsThatMatchHostname() {
  ...
  return filter((_window$document$styl = (_window = window) === null || _window === void 0 ? void 0 : (_window$document = _window.document) === null || _window$document === void 0 ? void 0 : _window$document.styleSheets) !== null && _window$document$styl !== void 0 ? _window$document$styl : [], function (styleSheet) {
    if (!styleSheet.href) {
      return false;
    }
