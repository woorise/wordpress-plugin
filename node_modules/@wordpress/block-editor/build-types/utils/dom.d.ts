 ...
 */
export function getBlockDOMNode(clientId: string, doc: Document): Element | null;
/**
 ...
 */
export function getBlockPreviewContainerDOMNode(clientId: string, doc: Document): Node | undefined;
/**
