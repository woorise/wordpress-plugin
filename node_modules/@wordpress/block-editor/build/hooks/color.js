...
var shouldSkipSerialization = function shouldSkipSerialization(blockType) {
  var colorSupport = (0, _blocks.getBlockSupport)(blockType, COLOR_SUPPORT_KEY);
...
function ColorEdit(props) {
  ...
  if (!hasColorSupport(blockName) || _element.Platform.OS !== 'web') {
    return null;
  }
  ...
  return (0, _element.createElement)(_colorPanel.default, {
    ...
    _element.Platform.OS === 'web' && !gradient && !(style !== null && style !== void 0 && (_style$color7 = style.color) !== null && _style$color7 !== void 0 && _style$color7.gradient),
