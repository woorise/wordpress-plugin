...
var withToolbarControls = (0, _compose.createHigherOrderComponent)(function (BlockEdit) {
  return function (props) {
    var blockName = props.name; // Compute the block allowed alignments without taking into account,
    // if the theme supports wide alignments or not
    // and without checking the layout for availble alignments.
    // BlockAlignmentToolbar takes both of these into account.

    var blockAllowedAlignments = getValidAlignments((0, _blocks.getBlockSupport)(blockName, 'align'), (0, _blocks.hasBlockSupport)(blockName, 'alignWide', true));
    var validAlignments = (0, _useAvailableAlignments.default)(blockAllowedAlignments);
...
var withDataAlign = (0, _compose.createHigherOrderComponent)(function (BlockListBlock) {
  return function (props) {
    ...
    var blockAllowedAlignments = getValidAlignments((0, _blocks.getBlockSupport)(name, 'align'), (0, _blocks.hasBlockSupport)(name, 'alignWide', true));
    var validAlignments = (0, _useAvailableAlignments.default)(blockAllowedAlignments); // If an alignment is not assigned, there's no need to go through the
