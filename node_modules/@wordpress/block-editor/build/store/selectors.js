...
exports.__experimentalGetActiveBlockIdByBlockNames = exports.__experimentalGetReusableBlockTitle = exports.__experimentalGetParsedReusableBlock = exports.__experimentalGetBlockListSettingsForBlocks = exports.__experimentalGetScopedBlockPatterns = exports.__experimentalGetAllowedPatterns = exports.__experimentalGetParsedPattern = exports.__experimentalGetAllowedBlocks = exports.hasInserterItems = exports.getBlockTransformItems = exports.getInserterItems = exports.canInsertBlockType = exports.isAncestorMultiSelected = exports.getMultiSelectedBlocks = exports.getSelectedBlockClientIds = exports.getBlockParentsByBlockName = exports.getBlockParents = exports.getBlocksByClientId = exports.getGlobalBlockCount = exports.getClientIdsWithDescendants = exports.getClientIdsOfDescendants = exports.__unstableGetClientIdsTree = exports.__unstableGetClientIdWithClientIdsTree = exports.__unstableGetBlockTree = exports.__unstableGetBlockWithBlockTree = exports.getBlocks = exports.__unstableGetBlockWithoutInnerBlocks = exports.getBlock = void 0;
...
var __unstableGetClientIdWithClientIdsTree = (0, _rememo.default)(function (state, clientId) {
  return {
    clientId: clientId,
...
var __unstableGetClientIdsTree = (0, _rememo.default)(function (state) {
  var rootClientId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return (0, _lodash.map)(getBlockOrder(state, rootClientId), function (clientId) {
...
var canInsertBlockTypeUnmemoized = function canInsertBlockTypeUnmemoized(state, blockName) {
  ...
  if (blockName && 'object' === (0, _typeof2.default)(blockName)) {
    blockType = blockName;
...
var getInserterItems = (0, _rememo.default)(function (state) {
  ...
  var sortedBlockTypes = [].concat((0, _toConsumableArray2.default)(visibleBlockTypeInserterItems), blockVariations).sort(prioritizeCoreBlocks);
  return [].concat((0, _toConsumableArray2.default)(sortedBlockTypes), (0, _toConsumableArray2.default)(reusableBlockInserterItems));
}, function (state, rootClientId) {
...
var getBlockTransformItems = (0, _rememo.default)(function (state, blocks) {
  var rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var buildBlockTypeTransformItem = buildBlockTypeItem(state, {
    buildScope: 'transform'
  });
  var blockTypeTransformItems = (0, _blocks.getBlockTypes)().filter(function (blockType) {
    return canIncludeBlockTypeInInserter(state, blockType, rootClientId);
  }).map(buildBlockTypeTransformItem);
  var itemsByName = (0, _lodash.mapKeys)(blockTypeTransformItems, function (_ref10) {
    var name = _ref10.name;
    return name;
  });
  var possibleTransforms = (0, _blocks.getPossibleBlockTransformations)(blocks).reduce(function (accumulator, block) {
  ...
  var possibleBlockTransformations = (0, _lodash.orderBy)(possibleTransforms, function (block) {
    return itemsByName[block.name].frecency;
  }, 'desc');
  return possibleBlockTransformations;
}, function (state, rootClientId) {
  return [state.blockListSettings[rootClientId], state.blocks.byClientId, state.preferences.insertUsage, state.settings.allowedBlockTypes, state.settings.templateLock, (0, _blocks.getBlockTypes)()];
});
/**
...
var __experimentalGetParsedPattern = (0, _rememo.default)(function (state, patternName) {
...
var __experimentalGetAllowedPatterns = (0, _rememo.default)(function (state) {
  var rootClientId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var patterns = state.settings.__experimentalBlockPatterns;
  ...
  var patternsAllowed = (0, _lodash.filter)(parsedPatterns, function (_ref13) {
...
var __experimentalGetScopedBlockPatterns = (0, _rememo.default)(function (state, scope, blockName) {
...
exports.__experimentalGetScopedBlockPatterns = __experimentalGetScopedBlockPatterns;
...
var __experimentalGetBlockListSettingsForBlocks = (0, _rememo.default)(function (state) {
  ...
  return clientIds.reduce(function (blockListSettingsForBlocks, clientId) {
    ...
    return _objectSpread(_objectSpread({}, blockListSettingsForBlocks), {}, (0, _defineProperty2.default)({}, clientId, state.blockListSettings[clientId]));
  }, {});
}, function (state) {
...
var __experimentalGetReusableBlockTitle = (0, _rememo.default)(function (state, ref) {
