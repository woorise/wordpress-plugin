...
exports.insertionPointVisibility = insertionPointVisibility;
      ...
      case 'UPDATE_BLOCK_ATTRIBUTES':
        {
          ...
          var next = action.clientIds.reduce(function (accumulator, id) {
            return _objectSpread(_objectSpread({}, accumulator), {}, (0, _defineProperty2.default)({}, id, (0, _lodash.reduce)(action.uniqueByBlock ? action.attributes[id] : action.attributes, function (result, value, key) {
  ...
  switch (action.type) {
    ...
    case 'REPLACE_BLOCKS':
      return action.blocks.reduce(function (prevState, block) {
        ...
        var variations = (0, _blocks.getBlockVariations)(blockName);
  ...
  switch (action.type) {
    ...
    case 'UPDATE_BLOCK_ATTRIBUTES':
      return action.clientIds.reduce(function (accumulator, id) {
        return _objectSpread(_objectSpread({}, accumulator), {}, (0, _defineProperty2.default)({}, id, action.uniqueByBlock ? action.attributes[id] : action.attributes));
      }, {});
  }
