...
function BlockPopover(_ref) {
  ...
  var blockNodes = (0, _element.useContext)(_.BlockNodes);
  ...
  var initialToolbarItemIndexRef = (0, _element.useRef)();
  (0, _element.useEffect)(function () {
  ...
  if (capturingClientId) {
    node = (0, _dom2.getBlockDOMNode)(capturingClientId, ownerDocument);
  }
...
function wrapperSelector(select) {
  ...
  var parentBlockListSettings = __experimentalGetBlockListSettingsForBlocks(blockParentsClientIds); // Get the clientId of the topmost parent with the capture toolbars setting.


  var capturingClientId = (0, _lodash.find)(blockParentsClientIds, function (parentClientId) {
