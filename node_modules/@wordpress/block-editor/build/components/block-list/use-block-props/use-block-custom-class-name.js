...
function useBlockCustomClassName(clientId) {
  ...
  return (0, _data.useSelect)(function (select) {
    ...
    var _getBlockAttributes = getBlockAttributes(clientId),
        className = _getBlockAttributes.className;

    if (!className) {
      return;
    }

    var blockType = (0, _blocks.getBlockType)(getBlockName(clientId));
    var hasLightBlockWrapper = blockType.apiVersion > 1 || (0, _blocks.hasBlockSupport)(blockType, 'lightBlockWrapper', false);
