...
var Inserter = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(Inserter, [{
    ...
    value: function onInserterToggledAnnouncement(isOpen) {
      _reactNative.AccessibilityInfo.fetch().done(function (isEnabled) {
        if (isEnabled) {
          var isIOS = _reactNative.Platform.OS === 'ios';
          var announcement = isOpen ? (0, _i18n.__)('Scrollable block menu opened. Select a block.') : (0, _i18n.__)('Scrollable block menu closed.');
          (0, _lodash.delay)(function () {
            return _reactNative.AccessibilityInfo.announceForAccessibility(announcement);
