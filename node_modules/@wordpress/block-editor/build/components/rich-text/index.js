...
function addActiveFormats(value, activeFormats) {
  if (activeFormats.length) {
    var index = value.formats.length;

    while (index--) {
      value.formats[index] = [].concat((0, _toConsumableArray2.default)(activeFormats), (0, _toConsumableArray2.default)(value.formats[index] || []));
    }
  }
}
/**
...
function RichTextWrapper(_ref2, forwardedRef) {
  ...
  var nativeProps = (0, _useNativeProps.useNativeProps)();
  ...
  var splitValue = (0, _element.useCallback)(function (record) {
    ...
    var lastPastedBlockIndex = -1; // Consider the after value to be the original it is not empty and
    // the before value *is* empty.

    var isAfterOriginal = (0, _richText.isEmpty)(before) && !(0, _richText.isEmpty)(after); // Create a block with the content before the caret if there's no pasted
    ...
    var initialPosition = hasPastedBlocks ? -1 : 0;
  ...
  var onPaste = (0, _element.useCallback)(function (_ref6) {
    ...
    if (isInternal) {
      var pastedValue = (0, _richText.create)({
        html: html,
        multilineTag: multilineTag,
  ...
  var mergedRef = (0, _compose.useMergeRefs)([forwardedRef, fallbackRef]);
  var content = (0, _element.createElement)(_richText.__experimentalRichText, (0, _extends2.default)({
    clientId: clientId,
