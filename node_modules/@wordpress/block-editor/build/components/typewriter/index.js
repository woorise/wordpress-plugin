...
function useTypewriter() {
  var hasSelectedBlock = (0, _data.useSelect)(function (select) {
    return select(_store.store).hasSelectedBlock();
  });
  return (0, _compose.useRefEffect)(function (node) {
    ...
    function maintainCaretPosition(_ref) {
      ...
      var currentCaretRect = (0, _dom.computeCaretRect)(defaultView);
      ...
      var scrollContainer = (0, _dom.getScrollContainer)(node); // The page must be scrollable.
    ...
    function isLastEditableNode() {
      var editableNodes = node.querySelectorAll('[contenteditable="true"]');
