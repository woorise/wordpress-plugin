 ...
 */
var getArrowIcon = function getArrowIcon(direction, orientation) {
  if (direction === 'up') {
...
var getMovementDirectionLabel = function getMovementDirectionLabel(moveDirection, orientation) {
  if (moveDirection === 'up') {
    if (orientation === 'horizontal') {
