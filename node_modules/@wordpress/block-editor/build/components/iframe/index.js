...
function Iframe(_ref2, ref) {
  var contentRef = _ref2.contentRef,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref2, ["contentRef", "children", "head", "headHTML"]);
  ...
  var setRef = (0, _element.useCallback)(function (node) {
    if (!node) {
      return;
    }
  ...
  return (0, _element.createElement)("iframe", (0, _extends2.default)({}, props, {
    ...
    name: "editor-canvas"
  }), iframeDocument && (0, _element.createPortal)(children, iframeDocument.body), iframeDocument && (0, _element.createPortal)(head, iframeDocument.head));
}
