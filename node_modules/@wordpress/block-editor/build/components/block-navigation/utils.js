...
var isClientIdSelected = function isClientIdSelected(clientId, selectedBlockClientIds) {
  return (0, _lodash.isArray)(selectedBlockClientIds) && selectedBlockClientIds.length ? selectedBlockClientIds.indexOf(clientId) !== -1 : selectedBlockClientIds === clientId;
};
