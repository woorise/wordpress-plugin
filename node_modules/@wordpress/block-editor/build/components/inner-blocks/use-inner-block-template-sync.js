...
function useInnerBlockTemplateSync(clientId, template, templateLock, templateInsertUpdatesSelection) {
  var getSelectedBlocksInitialCaretPosition = (0, _data.useSelect)(function (select) {
    return select(_store.store).getSelectedBlocksInitialCaretPosition;
  }, []);
  ...
  var innerBlocks = (0, _data.useSelect)(function (select) {
    return select(_store.store).getBlocks(clientId);
