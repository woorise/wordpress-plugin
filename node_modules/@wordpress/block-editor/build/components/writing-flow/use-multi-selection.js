  ...
  (0, _element.useEffect)(function () {
    ...
    if (!hasMultiSelection || isMultiSelecting) {
      ...
      if (_selection.rangeCount && !_selection.isCollapsed) {
        var blockNode = (0, _dom.getBlockDOMNode)(selectedBlockClientId, ownerDocument);
    ...
    var startNode = (0, _dom.getBlockDOMNode)(start, ownerDocument);
    var endNode = (0, _dom.getBlockDOMNode)(end, ownerDocument);
