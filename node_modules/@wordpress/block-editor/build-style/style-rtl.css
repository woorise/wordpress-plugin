...
.block-editor-block-navigation-leaf.is-branch-selected:not(.is-selected) .block-editor-block-navigation-block-contents:hover {
  background: #ddd;
}
...
.show-icon-labels .block-editor-block-contextual-toolbar.has-parent {
  margin-right: 0;
}
