...
export var RichText = /*#__PURE__*/function (_Component) {
  ...
  function RichText(_ref) {
    ...
    _this.restoreParagraphTags = _this.restoreParagraphTags.bind(_assertThisInitialized(_this));
    _this.onChangeFromAztec = _this.onChangeFromAztec.bind(_assertThisInitialized(_this));
    ...
    _this.convertFontSizeFromString = _this.convertFontSizeFromString.bind(_assertThisInitialized(_this));
    _this.manipulateEventCounterToForceNativeToRefresh = _this.manipulateEventCounterToForceNativeToRefresh.bind(_assertThisInitialized(_this));
    _this.shouldDropEventFromAztec = _this.shouldDropEventFromAztec.bind(_assertThisInitialized(_this));
    _this.state = {
      activeFormats: [],
      selectedFormat: null,
      height: 0
