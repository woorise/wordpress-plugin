...
var RichText = /*#__PURE__*/function (_Component) {
  ...
  function RichText(_ref) {
    ...
    _this.restoreParagraphTags = _this.restoreParagraphTags.bind((0, _assertThisInitialized2.default)(_this));
    _this.onChangeFromAztec = _this.onChangeFromAztec.bind((0, _assertThisInitialized2.default)(_this));
    ...
    _this.convertFontSizeFromString = _this.convertFontSizeFromString.bind((0, _assertThisInitialized2.default)(_this));
    _this.manipulateEventCounterToForceNativeToRefresh = _this.manipulateEventCounterToForceNativeToRefresh.bind((0, _assertThisInitialized2.default)(_this));
    _this.shouldDropEventFromAztec = _this.shouldDropEventFromAztec.bind((0, _assertThisInitialized2.default)(_this));
    _this.state = {
      activeFormats: [],
      selectedFormat: null,
      height: 0
  ...
  (0, _createClass2.default)(RichText, [{
    ...
    key: "convertFontSizeFromString",
    value: function convertFontSizeFromString(fontSize) {
    ...
    key: "onChangeFromAztec",
    value: function onChangeFromAztec(event) {
    ...
    value: function onTextUpdate(event) {
      ...
      var formattedContent = contentWithoutRootTag;
      ...
      var refresh = this.value !== formattedContent;
    ...
    key: "restoreParagraphTags",
    value: function restoreParagraphTags(value, tag) {
    ...
    key: "shouldDropEventFromAztec",
    value: function shouldDropEventFromAztec(event, logText) {
      var shouldDrop = !this.isIOS && event.nativeEvent.eventCount <= this.lastEventCount;

      if (shouldDrop) {
        window.console.log("Dropping ".concat(logText, " from Aztec as its event counter is older than latest sent to the native side. Got ").concat(event.nativeEvent.eventCount, " but lastEventCount is ").concat(this.lastEventCount, "."));
      }
    ...
    key: "manipulateEventCounterToForceNativeToRefresh",
    value: function manipulateEventCounterToForceNativeToRefresh() {
      if (this.isIOS) {
    ...
    value: function render() {
      ...
      var containerStyles = (style === null || style === void 0 ? void 0 : style.padding) && (style === null || style === void 0 ? void 0 : style.backgroundColor) && {
