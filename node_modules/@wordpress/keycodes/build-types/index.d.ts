 ...
 */
export const modifiers: Record<WPKeycodeModifier, (isApple: () => boolean) => WPModifierPart[]>;
/**
...
export type WPModifierPart = "alt" | "ctrl" | "meta" | "shift";
export type WPKeycodeModifier = "shift" | "alt" | "ctrl" | "primary" | "primaryShift" | "primaryAlt" | "secondary" | "access" | "ctrlShift" | "shiftAlt";
/**
 * An object of handler functions for each of the possible modifier
 * combinations. A handler will return a value for a given key.
 */
export type WPModifierHandler<T> = {
    shift: T;
    alt: T;
    ctrl: T;
    primary: T;
