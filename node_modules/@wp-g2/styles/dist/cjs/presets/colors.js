...
var color = function (value) {
  return (0, _utils.colorize)(value);
};

exports.color = color;
color.admin = (0, _core.get)('colorAdmin');
color.text = (0, _core.get)('colorText');
color.textInverted = (0, _core.get)('colorTextInverted');
color.border = (0, _core.get)('surfaceBorderColor');
color.positive = (0, _core.get)('colorPositive');
color.destructive = (0, _core.get)('colorDestructive');
/**
 * Add supported colors to the color() method
 */

_config.SUPPORTED_COLORS.forEach(function (value) {
  [null, 100, 300, 500, 700, 900].forEach(function (shade) {
    if (!shade) {
      // @ts-ignore Generated string passed to `get`
      color[value] = (0, _core.get)(value + "500");
    } else {
      // @ts-ignore Generated string passed to `get`
      color["" + value + shade] = (0, _core.get)("" + value + shade);
    }
  });
});
/**
...
Object.keys(_tokens.G2_COLORS).forEach(function (value) {
  // @ts-ignore Generated string passed to `get`
  color[value] = (0, _core.get)(value);
});