...
exports.getZIndexRegistry = getZIndexRegistry;
...
function getZIndex(namespace, fallback) {
...
function getZIndexRegistry() {
  return _objectSpread({}, Z_INDEX_REGISTRY);
}