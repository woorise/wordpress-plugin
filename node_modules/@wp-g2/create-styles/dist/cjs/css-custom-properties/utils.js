...
exports.sanitizeParens = sanitizeParens;
exports.VAR_REG_EXP = void 0;

var _lodash = require("lodash");

var VAR_REG_EXP = new RegExp(/var\(.*?\)[ ) ]*/, 'g');
/**
...
exports.VAR_REG_EXP = VAR_REG_EXP;
...
function sanitizeParens(value) {
  ...
  if (parenStartCount > parenEndCount) {
    ...
    var append = (0, _lodash.repeat)(')', parenStartCount - parenEndCount);
    result = "" + value + append;
  } else {
