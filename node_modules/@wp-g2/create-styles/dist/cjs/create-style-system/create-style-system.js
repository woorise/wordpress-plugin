...
exports.createStyleSystem = createStyleSystem;
...
var _createCoreElement2 = require("./create-core-element");

var _createCoreElements = require("./create-core-elements");

var _createStyledComponents = require("./create-styled-components");

var _generateTheme = require("./generate-theme");
...
var defaultOptions = _utils.DEFAULT_STYLE_SYSTEM_OPTIONS;
...
function createStyleSystem(options) {
  if (options === void 0) {
  ...
  var globalStyles = (0, _generateTheme.generateTheme)({
    config: config,
    darkHighContrastModeConfig: darkHighContrastModeConfig,
    darkModeConfig: darkModeConfig,
    highContrastModeConfig: highContrastModeConfig
  });
  var rootStore = (0, _cssCustomProperties.createRootStore)(globalStyles.globalVariables);
  rootStore.setState(globalStyles.globalVariables);
  /**
   * Compiler (Custom Emotion instance).
   */

  var compiler = (0, _createCompiler.createCompiler)(_objectSpread(_objectSpread({}, compilerOptions), {}, {
    rootStore: rootStore
  }));
  ...
  var core = (0, _createCoreElements.createCoreElements)({
  ...
  var styled = (0, _createStyledComponents.createStyledComponents)({
    compiler: compiler,
    core: core
  });
  /**
  ...
  return {
    ...
    createCoreElement: function _createCoreElement(tagName) {
      return (0, _createCoreElement2.createCoreElement)(tagName, {
        baseStyles: baseStyles,
        compiler: compiler,
        globalStyles: globalStyles
      });
    },
    createToken: _utils.createToken,
    css: css,
    cx: cx,
    get: function get(
    /** @type {keyof TConfig | keyof TDarkConfig | keyof THCConfig | keyof TDarkHCConfig | TGeneratedTokens} */
    key) {
      return "var(" + (0, _utils.createToken)(key.toString()) + ")";
    },
    styled: styled,
    View: View,
    ...
    props) {
      return /*#__PURE__*/_react.default.createElement(_themeProvider.ThemeProvider, Object.assign({}, props, {
        compiler: compiler,
        globalStyles: globalStyles
      }));
    },
...
var _default = createStyleSystem;
