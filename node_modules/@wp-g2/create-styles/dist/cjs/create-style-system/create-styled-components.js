 ...
 */
function createStyledComponents(_ref) {
  ...
  function createStyled(tagName, options) {
    ...
    return function () {
      ...
      var interpolationClassName = (0, _utils2.getInterpolatedClassName)(generateInterpolationName());
      ...
      var StyledComponent = /*#__PURE__*/_react.default.forwardRef(function render(_ref2, ref) {
        var asProp = _ref2.as,
            className = _ref2.className,
            props = (0, _objectWithoutProperties2.default)(_ref2, ["as", "className"]);
        ...
        var interpolatedStyles = (0, _utils2.compileInterpolatedStyles)(interpolatedProps, props);
        var classes = cx(css.apply(void 0, interpolatedStyles), className, interpolationClassName);
        return /*#__PURE__*/_react.default.createElement(Box, Object.assign({
          as: asProp || tagName
        }, mergedProps, {
          className: classes
        }));
      ...
      StyledComponent.displayName = typeof tagName === 'string' ? "Styled(" + (0, _utils.getDisplayName)(tagName) + ")" : _utils.is.defined(tagName == null ? void 0 : tagName.displayName) ? tagName.displayName : "Styled(" + (0, _utils.getDisplayName)(tagName) + ")";
      /*
      ...
      StyledComponent[_constants.INTERPOLATION_CLASS_NAME] = interpolationClassName;
      ...
      if (typeof tagName !== 'string') {
         ...
         */
        return (0, _utils.hoistNonReactStatics)(StyledComponent, tagName);
      } else {
  ...
  _tags.tags.forEach(function (tagName) {
