...
exports.createCoreElements = createCoreElements;

var _createCoreElement = require("./create-core-element");
 ...
 */
function createCoreElements(_ref) {
  ...
  tagName) {
    return (0, _createCoreElement.createCoreElement)(tagName, {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(_tags.tags), _step; !(_step = _iterator()).done;) {
