...
export const REDUCED_MOTION_MODE_ATTR_PROP: "data-system-ui-reduced-motion-mode";
export const DARK_MODE_ATTR: string;
export const HIGH_CONTRAST_MODE_MODE_ATTR: string;
export const COLOR_BLIND_MODE_ATTR: string;
export const REDUCED_MOTION_MODE_ATTR: string;
export const DARK_HIGH_CONTRAST_MODE_MODE_ATTR: string;
