import { getInterpolatedClassName, INTERPOLATION_CLASS_NAME } from '@wp-g2/create-styles';
...
export function contextConnect(Component, namespace, options) {
  ...
  var WrappedComponent = /*#__PURE__*/forwardRef(Component);

  if (memo) {
    // @ts-ignore
    WrappedComponent = /*#__PURE__*/React.memo(WrappedComponent);
  }
  ...
  var mergedNamespace = WrappedComponent[CONNECT_STATIC_NAMESPACE] || [displayName];
  /**
  ...
  WrappedComponent[CONNECT_STATIC_NAMESPACE] = uniq(mergedNamespace); // @ts-ignore internal property

  WrappedComponent[INTERPOLATION_CLASS_NAME] = getInterpolatedClassName(displayName); // @ts-ignore
...
export var getNamespace = getConnectNamespace;
export var hasNamespace = hasConnectNamespace;