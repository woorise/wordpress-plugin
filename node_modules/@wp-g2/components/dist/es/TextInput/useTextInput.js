...
var useRootEventHandlers = function (_ref) {
  ...
  var handleOnTouchStart = useCallback(function () {
    inputRef.current.focus();
  }, [inputRef]);
...
export function useTextInput(props) {
  var _useContextSystem = useContextSystem(props, 'TextInput'),
  ...
  var _useTextInputState = useTextInputState(_objectSpread(_objectSpread({}, otherProps), {}, {
    ...
    type: type
      ...
      textInputState = _objectWithoutProperties(_useTextInputState, ["decrement", "dragHandlersRef", "increment", "inputRef", "isFocused", "isInputTypeNumeric", "isTypeNumeric", "scrollHandlers", "value"]);
  ...
  var baseFieldProps = useBaseField({
    align: align,
    disabled: disabled,
    error: error,
    gap: gap,
  ...
  var InputComponent = multiline ? TextareaAutosize : 'input';
  var classes = useMemo(function () {
    return cx(baseFieldProps.className, multiline && styles.multiline, className);
  }, [baseFieldProps.className, className, multiline]);
  var inputClasses = useMemo(function () {
    return cx(styles.Input, styles[size], multiline && styles.inputMultiline, isResizable && styles.resizable, multiline && styles.scrollableScrollbar);
