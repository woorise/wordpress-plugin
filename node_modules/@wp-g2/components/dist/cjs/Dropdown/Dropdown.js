...
function Dropdown(props, forwardedRef) {
  var _useContextSystem = (0, _context.useContextSystem)(props, 'Dropdown'),
      ...
      otherProps = (0, _objectWithoutProperties2.default)(_useContextSystem, ["animated", "animationDuration", "animationTimingFunction", "baseId", "children", "gutter", "id", "label", "modal", "placement", "state", "visible"]);

  var _menu = (0, _reakit.useMenuState)(_objectSpread({
  ...
  var contextProps = (0, _react.useMemo)(function () {
  ...
  return /*#__PURE__*/_react.default.createElement(_Dropdown.DropdownContext.Provider, {
    ref: forwardedRef,
    value: contextProps
  }, (0, _utils.renderChildren)(children, mapMenuStateToProps(menu)));
}
/**
...
var ConnectedDropdown = (0, _context.contextConnect)(Dropdown, 'Dropdown');
