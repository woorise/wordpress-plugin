...
function createHighlighterText(_ref) {
  ...
  var highlightStyles;
  var memoizedLowercaseProps = (0, _utils.memoize)(function lowercaseProps(object) {
    var mapped = {};
  ...
  var textContent = chunks.map(function (chunk, index) {
    ...
    if (chunk.highlight) {
      ...
      return /*#__PURE__*/(0, _react.createElement)(HighlightTag, props);
    } else {
      return /*#__PURE__*/(0, _react.createElement)('span', _objectSpread(_objectSpread({}, _styles.ui.$('Text')), {}, {
        children: text,
