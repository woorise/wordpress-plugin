...
var _useListState3 = require("../useListState");
...
describe('useListState', function () {
  test('should adjust array state based on provided data methods', function () {
    var _render = (0, _react.render)( /*#__PURE__*/_react2.default.createElement(function Component() {
      var _useListState = (0, _useListState3.useListState)([{
        id: 1
      }, {
        id: 2
      }, {
      ...
      return /*#__PURE__*/_react2.default.createElement("div", null, /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.add({
            id: state.length + 1
          });
        }
      }, "add"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.remove({
            at: state.length - 1
          });
        }
      }, "remove"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.remove({
            id: 3
          });
        }
      }, "removeId"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.append({
            id: 'append'
          });
        }
      }, "append"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.prepend({
            id: 'prepend'
          });
        }
      }, "prepend"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.move(state.length - 1, 0);
        }
      }, "move"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
      ...
      }, "insert"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.set([]);
        }
      }, "set"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.setState([{
            id: 1
          }]);
        }
      }, "setState"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.remove(function (item) {
            return item.id === 1;
          });
        }
      }, "removeOne"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
          return stateFns.removeAll(function (item) {
            return typeof item.id === 'number';
          });
        }
      }, "removeAll"), /*#__PURE__*/_react2.default.createElement("button", {
        onClick: function onClick() {
      ...
      }, "update"), /*#__PURE__*/_react2.default.createElement("div", null, stateFns.has({
        id: 1
      }) ? 'has' : 'no'), /*#__PURE__*/_react2.default.createElement("div", null, stateFns.find({
        id: 1
      }) ? 'find' : 'no'), /*#__PURE__*/_react2.default.createElement("div", null, stateFns.get({
        at: 1
      }) ? 'get' : 'no'), /*#__PURE__*/_react2.default.createElement("div", null, stateFns.indexOf({
        id: 1
      }) ? '1' : '0'), /*#__PURE__*/_react2.default.createElement("div", null, stateFns.find({
        id: 100
      }) ? 'yes' : 'no'), /*#__PURE__*/_react2.default.createElement("div", null, stateFns.find({}) ? 'yes' : 'no'), /*#__PURE__*/_react2.default.createElement("div", null, stateFns.update({
        id: 'nooooope'
      }) ? 'yes' : 'no'), /*#__PURE__*/_react2.default.createElement("ul", null, state.map(function (item) {
    ...
    _react.fireEvent.click(removeOne);

    expect(list.children).toHaveLength(4);
    expect(list.innerHTML).not.toContain('1'); // removeAll

    _react.fireEvent.click(removeAll);
    ...
    _react.fireEvent.click(removeId);

    expect(list.children).toHaveLength(4); // update

    _react.fireEvent.click(update);
