...
function useBoolState(initialState) {
  process.env.NODE_ENV !== "production" ? (0, _tinyWarning.default)(_is.is.boolean(initialState), ['use-enhanced-state', 'useBoolState', 'State must be a boolean.'].join('\n')) : void 0;

  var _useState = (0, _react.useState)(initialState || false),
      _useState2 = _slicedToArray(_useState, 2),
      state = _useState2[0],
      setState = _useState2[1];

  var truthy = (0, _react.useCallback)(function () {
    return setState(true);
  }, []);
  var falsy = (0, _react.useCallback)(function () {
